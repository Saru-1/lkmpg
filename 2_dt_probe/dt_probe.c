...
/*Meta information */
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Saru-1");
MODULE_DESCRIPTION("A simple linux kernel module to parse device tree for a specific device and its properties");
...
static int dt_probe(struct platform_device *pdev){
	...
	printk("dt_probe - Now I am the probe function\n");
...
static void __exit my_exit(void)
{
	...
	printk("dt_probe - unoading the driver...\n");
